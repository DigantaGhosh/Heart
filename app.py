...
st.write("Enter your details to assess your Cardiovascular Risk Level.")
...
# Prediction
if st.button("Predict My CVD Risk"):
    pred = clf.predict(input_df)[0]
    result = label_encoder.inverse_transform([pred])[0]
    st.success(f"Your predicted CVD Risk Level is: **{result}**")
